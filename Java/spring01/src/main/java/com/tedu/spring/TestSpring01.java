...
public class TestSpring01 {
    ...
    /**
     * 3、测试spring的DI(依赖注入)
     * (1) set方法注入:是通过对象的setXxx方法给对象的xxx属性赋值
     *    在property标签的name属性上指定的值要和当前对象的属性名保持一致
     * (2)构造方法注入:通过对象的有参构造函数给对象的属性赋值
     *    在constructor-age标签的name属性上指定的值要和当前对象的含参构造器的形参的名字保持一致
     **/
    @Test
    public void testDI1() {
        /*通过spring容器获取UserInfo类的实例*/
